...
> CircuitPython libraries for hardware projects

Part of the [BlackRoad OS](https://blackroad.io) ecosystem. Forked from [`adafruit/Adafruit_CircuitPython_Bundle`](https://github.com/adafruit/Adafruit_CircuitPython_Bundle).
